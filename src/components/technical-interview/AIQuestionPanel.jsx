...
function AIQuestionPanel({ currentQuestion, questionNumber, totalQuestions, isInterviewActive, allAnswered, onSkipQuestion, canSkip, onSpeechStatusChange }) {
  ...
  useEffect(() => {
    if (currentQuestion && isInterviewActive) {
      ...
      // Notify parent immediately that AI is about to speak
  ...
  }, [currentQuestion, isInterviewActive, onSpeechStatusChange]);
